...
#define HAL_OR_ASSIGN_UINT32( _register_, _value_ )                     \
    CYG_MACRO_START                                                     \
    CYG_WORD32 read , write;                                            \
    HAL_READ_UINT32(_register_,read);                                   \
    write = read | _value_;                                             \
    HAL_WRITE_UINT32(_register_,write);                                 \
    CYG_MACRO_END

#define HAL_AND_ASSIGN_UINT32( _register_, _value_ )                    \
    CYG_MACRO_START                                                     \
    CYG_WORD32 read , write;                                            \
    HAL_READ_UINT32(_register_,read);                                   \
    write = read & _value_;                                             \
