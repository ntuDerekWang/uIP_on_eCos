...
//==================103RC configuration==================//
    ...
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_CRL, 0xBFB38B33 );
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_CRH, 0x888338B3 );
/*  
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_IDR, 0x000046BC);
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_ODR, 0x0000A418 );
 */
    ...
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_CRL, 0xFF384300 );
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_CRH, 0xBFB3FF33 );
  //  HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_IDR, 0x0000ecd4 );
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_ODR, 0x00000014 );
      
    base = CYGHWR_HAL_STM32_GPIOC;
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_CRL, 0x33388830 );
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_CRH, 0x448bfb33 );
 //   HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_IDR, 0x0000e03e );
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_ODR, 0x0000203e );


    base = CYGHWR_HAL_STM32_GPIOD;


    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_CRL, 0x44444444 );
    HAL_WRITE_UINT32( base+CYGHWR_HAL_STM32_GPIO_CRH, 0x44444444 );
