...
#define CR_HSEBYP_Reset           ((cyg_uint32)0xFFFBFFFF)
#define CR_HSEBYP_Set             ((cyg_uint32)0x00040000)
#define CR_HSEON_Reset            ((cyg_uint32)0xFFFEFFFF)
#define CR_HSEON_Set              ((cyg_uint32)0x00010000)
#define CR_HSITRIM_Mask           ((cyg_uint32)0xFFFFFF07)

/* CFGR register bit mask */
#ifndef STM32F10X_CL
 #define CFGR_PLL_Mask            ((cyg_uint32)0xFFC0FFFF)
#else
 #define CFGR_PLL_Mask           ((cyg_uint32)0xFFC2FFFF)
#endif /* STM32F10X_CL */ 

#define CFGR_PLLMull_Mask         ((cyg_uint32)0x003C0000)
#define CFGR_PLLSRC_Mask          ((cyg_uint32)0x00010000)
#define CFGR_PLLXTPRE_Mask        ((cyg_uint32)0x00020000)
#define CFGR_SWS_Mask             ((cyg_uint32)0x0000000C)
#define CFGR_SW_Mask              ((cyg_uint32)0xFFFFFFFC)
#define CFGR_HPRE_Reset_Mask      ((cyg_uint32)0xFFFFFF0F)
#define CFGR_HPRE_Set_Mask        ((cyg_uint32)0x000000F0)
#define CFGR_PPRE1_Reset_Mask     ((cyg_uint32)0xFFFFF8FF)
#define CFGR_PPRE1_Set_Mask       ((cyg_uint32)0x00000700)
#define CFGR_PPRE2_Reset_Mask     ((cyg_uint32)0xFFFFC7FF)
#define CFGR_PPRE2_Set_Mask       ((cyg_uint32)0x00003800)
#define CFGR_ADCPRE_Reset_Mask    ((cyg_uint32)0xFFFF3FFF)
#define CFGR_ADCPRE_Set_Mask      ((cyg_uint32)0x0000C000)

/* CSR register bit mask */
#define CSR_RMVF_Set              ((cyg_uint32)0x01000000)

#ifdef STM32F10X_CL
/* CFGR2 register bit mask */
 #define CFGR2_PREDIV1SRC         ((cyg_uint32)0x00010000)
 #define CFGR2_PREDIV1            ((cyg_uint32)0x0000000F)
 #define CFGR2_PREDIV2            ((cyg_uint32)0x000000F0)
 #define CFGR2_PLL2MUL            ((cyg_uint32)0x00000F00)
 #define CFGR2_PLL3MUL            ((cyg_uint32)0x0000F000)
#endif /* STM32F10X_CL */ 

/* RCC Flag Mask */
#define FLAG_Mask                 ((cyg_uint8)0x1F)

#ifndef HSI_Value
/* Typical Value of the HSI in Hz */
 #define HSI_Value                 ((cyg_uint32)12000000)
#endif /* HSI_Value */

/* CIR register byte 2 (Bits[15:8]) base address */
#define CIR_BYTE2_ADDRESS         ((cyg_uint32)0x40021009)

/* CIR register byte 3 (Bits[23:16]) base address */
#define CIR_BYTE3_ADDRESS         ((cyg_uint32)0x4002100A)

/* CFGR register byte 4 (Bits[31:24]) base address */
#define CFGR_BYTE4_ADDRESS        ((cyg_uint32)0x40021007)
...
/* Time out for HSE start up */
 #define HSEStartUp_TimeOut        ((cyg_uint16)0x0500)
...
static volatile cyg_uint8 APBAHBPrescTable[16] = {0, 0, 0, 0, 1, 2, 3, 4, 1, 2, 3, 4, 6, 7, 8, 9};
static volatile cyg_uint8 ADCPrescTable[4] = {2, 4, 6, 8};
...
{
  /* Set HSION bit */
  RCC_TypeDef* RCC = (RCC_TypeDef *)CYGHWR_HAL_STM32_RCC;
  RCC->CR |= (cyg_uint32)0x00000001;

  /* Reset SW, HPRE, PPRE1, PPRE2, ADCPRE and MCO bits */
#ifndef STM32F10X_CL
  RCC->CFGR &= (cyg_uint32)0xF8FF0000;
#else
  RCC->CFGR &= (cyg_uint32)0xF0FF0000;
#endif /* STM32F10X_CL */   
  
  /* Reset HSEON, CSSON and PLLON bits */
  RCC->CR &= (cyg_uint32)0xFEF6FFFF;

  /* Reset HSEBYP bit */
  RCC->CR &= (cyg_uint32)0xFFFBFFFF;

  /* Reset PLLSRC, PLLXTPRE, PLLMUL and USBPRE/OTGFSPRE bits */
  RCC->CFGR &= (cyg_uint32)0xFF80FFFF;
...
/**
  ...
  * - SUCCESS(NOT_ERROR): HSE oscillator is stable and ready to use
  * - ERROR: HSE oscillator not yet ready
  */
ErrorStatus RCC_WaitForHSEStartUp(void)
{
  volatile cyg_uint32 StartUpCounter = 0;
...
void RCC_AdjustHSICalibrationValue(cyg_uint8 HSICalibrationValue)
{
  ...
  tmpreg |= (cyg_uint32)HSICalibrationValue << 3;
  /* Store the new value */
  RCC->CR = tmpreg;
}
...
{
 *(volatile cyg_uint32 *) CR_HSION_BB = (cyg_uint32)NewState;
}
*/
/**
...
{
 *(volatile cyg_uint32 *) CR_PLLON_BB = (cyg_uint32)NewState;
}
*/
...
{
  *(volatile cyg_uint32 *) CR_PLL2ON_BB = (cyg_uint32)NewState;
}
...
{
  *(volatile cyg_uint32 *) CR_PLL3ON_BB = (cyg_uint32)NewState;
}
#endif /* STM32F10X_CL */
...
{
  RCC_TypeDef* RCC = (RCC_TypeDef *)CYGHWR_HAL_STM32_RCC;
  return ((cyg_uint8)(RCC->CFGR & CFGR_SWS_Mask));
}
...
void RCC_ITConfig(cyg_uint8 RCC_IT, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    *(volatile cyg_uint8 *) CIR_BYTE2_ADDRESS |= RCC_IT;
  }
  else
  {
    /* Perform Byte access to RCC_CIR bits to disable the selected interrupts */
    *(volatile cyg_uint8 *) CIR_BYTE2_ADDRESS &= (cyg_uint8)~RCC_IT;
  }
}
...
{
  *(volatile cyg_uint32 *) CFGR_USBPRE_BB = RCC_USBCLKSource;
}
*/
#else
/**
...
{
   *(volatile cyg_uint32 *) CFGR_OTGFSPRE_BB = RCC_OTGFSCLKSource;
}
#endif /* STM32F10X_CL */ 
...
{
  *(volatile cyg_uint32 *) CFGR2_I2S2SRC_BB = RCC_I2S2CLKSource;
}
...
{
 *(volatile cyg_uint32 *) CFGR2_I2S3SRC_BB = RCC_I2S3CLKSource;
}
*/
#endif /* STM32F10X_CL */
...
void RCC_LSEConfig(cyg_uint8 RCC_LSE)
{
  ...
  // Reset LSEON bit 
  *(volatile cyg_uint8 *) BDCR_ADDRESS = RCC_LSE_OFF;
  // Reset LSEBYP bit 
  *(volatile cyg_uint8 *) BDCR_ADDRESS = RCC_LSE_OFF;
  ...
  switch(RCC_LSE)
  {
    case RCC_LSE_ON:
      // Set LSEON bit 
      *(volatile cyg_uint8 *) BDCR_ADDRESS = RCC_LSE_ON;
      break;
      
    case RCC_LSE_Bypass:
      // Set LSEBYP and LSEON bits 
      *(volatile cyg_uint8 *) BDCR_ADDRESS = RCC_LSE_Bypass | RCC_LSE_ON;
      break;            
...
{
   *(volatile cyg_uint32 *) CSR_LSION_BB = (cyg_uint32)NewState;
}
*/
/**
  * @brief  Configures the RTC clock (RTCCLK).
  * @note   Once the RTC clock is selected it can be changed unless the Backup domain is reset.
...
{
   *(volatile cyg_uint32 *) BDCR_RTCEN_BB = (cyg_uint32)NewState;
}
*/
/**
...
{
  cyg_uint32 tmp = 0, pllmull = 0, pllsource = 0, presc = 0;
  RCC_TypeDef* RCC = (RCC_TypeDef *)CYGHWR_HAL_STM32_RCC;
#ifdef  STM32F10X_CL
  cyg_uint32 prediv1source = 0, prediv1factor = 0, prediv2factor = 0, pll2mull = 0;
#endif // STM32F10X_CL 
  ...
  switch (tmp)
  {
    ...
    case 0x08:  // PLL used as system clock 
      ...
      {// HSE selected as PLL clock entry 
        if ((RCC->CFGR & CFGR_PLLXTPRE_Mask) != (cyg_uint32)RESET)
...
{
   *(volatile cyg_uint32 *) BDCR_BDRST_BB = (cyg_uint32)NewState;
}
*/
/**
...
{
  *(volatile cyg_uint32 *) CR_CSSON_BB = (cyg_uint32)NewState;
}
*/
/**
...
void RCC_MCOConfig(cyg_uint8 RCC_MCO)
{
  ...
  *(volatile cyg_uint8 *) CFGR_BYTE4_ADDRESS = RCC_MCO;
}
...
FlagStatus RCC_GetFlagStatus(cyg_uint8 RCC_FLAG)
{
  ...
  if ((statusreg & ((cyg_uint32)1 << tmp)) != (cyg_uint32)RESET)
  {
    bitstatus = SET;
  }
  else
...
ITStatus RCC_GetITStatus(cyg_uint8 RCC_IT)
{
  ...
  if ((RCC->CIR & RCC_IT) != (cyg_uint32)RESET)
  {
    bitstatus = SET;
  }
  else
...
void RCC_ClearITPendingBit(cyg_uint8 RCC_IT)
{
  /* Perform Byte access to RCC_CIR[23:16] bits to clear the selected interrupt
     pending bits */
  *(volatile cyg_uint8 *) CIR_BYTE3_ADDRESS = RCC_IT;
}
